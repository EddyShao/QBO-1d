...
The stochasticity enters the story by by making $F_S_0$￼(total source flux) and ￼$C_w$(spectral width) Random Variables of time. (In practice, these two array are denoted ￼).
