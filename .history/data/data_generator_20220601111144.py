...
model = WaveSpectrum(solver, *pert_mat[2])
time = solver.time
z = solver.z
...
np.save('/Users/eddysmac/Desktop/QBO-Research/qbo1d/sf.npy', sf, allow_pickle=False)
np.save('/Users/eddysmac/Desktop/QBO-Research/qbo1d/cw.npy', sf, allow_pickle=False)
